...
> Places getCoverageLonLatPlacesId(lat, lon, id, bssStands, addPoiInfos, disableGeojson)
...
try {
    Places result = apiInstance.getCoverageLonLatPlacesId(lat, lon, id, bssStands, addPoiInfos, disableGeojson);
...
> Places getCoverageRegionPlacesId(region, id, bssStands, addPoiInfos, disableGeojson)
...
Boolean disableGeojson = true; // Boolean | remove geojson from the response
try {
    Places result = apiInstance.getCoverageRegionPlacesId(region, id, bssStands, addPoiInfos, disableGeojson);
    System.out.println(result);
} catch (ApiException e) {
...
# **getPlacesId**
> Places getPlacesId(id, bssStands, addPoiInfos, disableGeojson)
...
Boolean disableGeojson = true; // Boolean | remove geojson from the response
try {
    Places result = apiInstance.getPlacesId(id, bssStands, addPoiInfos, disableGeojson);
    System.out.println(result);
} catch (ApiException e) {
