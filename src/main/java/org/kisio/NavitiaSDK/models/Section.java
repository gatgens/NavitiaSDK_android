...
public class Section implements Parcelable {
  ...
  **/
  ...
  public Section dataFreshness(String dataFreshness) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transferType, from, links, arrivalDateTime, additionalInformations, departureDateTime, displayInformations, to, baseArrivalDateTime, baseDepartureDateTime, co2Emission, geojson, duration, path, stopDateTimes, type, id, dataFreshness, mode);
  }
  ...
  Section(Parcel in) {
    ...
    transferType = (String)in.readValue(null);
