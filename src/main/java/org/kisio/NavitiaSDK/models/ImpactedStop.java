...
public class ImpactedStop implements Parcelable {
  ...
  private String stopTimeEffect = null;
  ...
  **/
  ...
  public ImpactedStop stopTimeEffect(String stopTimeEffect) {
  ...
  **/
  @ApiModelProperty(value = "")
  public String getStopTimeEffect() {
    return stopTimeEffect;
  }

  public void setStopTimeEffect(String stopTimeEffect) {
    this.stopTimeEffect = stopTimeEffect;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amendedArrivalTime, stopPoint, stopTimeEffect, departureStatus, amendedDepartureTime, baseArrivalTime, cause, baseDepartureTime, arrivalStatus);
  }
  ...
  ImpactedStop(Parcel in) {
    ...
    stopTimeEffect = (String)in.readValue(null);
