...
public class LineReportsApi {
    ...
    private com.squareup.okhttp.Call getCoverageLonLatLineReportsValidateBeforeCall(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatLineReportsCall(lat, lon, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        return call;
     ...
     */
    protected LineReports getCoverageLonLatLineReports(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        ApiResponse<LineReports> resp = getCoverageLonLatLineReportsWithHttpInfo(lat, lon, depth, count, startPage, forbiddenUris, disableGeojson, since, until);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    private ApiResponse<LineReports> getCoverageLonLatLineReportsWithHttpInfo(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageLonLatLineReportsValidateBeforeCall(lat, lon, depth, count, startPage, forbiddenUris, disableGeojson, since, until, null, null);
     ...
     */
    protected com.squareup.okhttp.Call getCoverageLonLatLineReportsAsync(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<LineReports> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatLineReportsValidateBeforeCall(lat, lon, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LineReports>(){}.getType();
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageLonLatLineReportsAsyncRaw(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<String > callback) throws ApiException {
    ...
    public class CoverageLonLatLineReportsRequestBuilder {
        ...
        public com.squareup.okhttp.Call get(final ApiCallback<LineReports > callback) throws ApiException {
            return currentApi.getCoverageLonLatLineReportsAsync(this.lat, this.lon, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }

        public com.squareup.okhttp.Call rawGet(final ApiCallback<String > callback) throws ApiException {
            return currentApi.getCoverageLonLatLineReportsAsyncRaw(this.lat, this.lon, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }
    }
    /**
    ...
    private com.squareup.okhttp.Call getCoverageLonLatUriLineReportsValidateBeforeCall(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatUriLineReportsCall(lat, lon, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    protected LineReports getCoverageLonLatUriLineReports(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        ApiResponse<LineReports> resp = getCoverageLonLatUriLineReportsWithHttpInfo(lat, lon, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    private ApiResponse<LineReports> getCoverageLonLatUriLineReportsWithHttpInfo(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageLonLatUriLineReportsValidateBeforeCall(lat, lon, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until, null, null);
        Type localVarReturnType = new TypeToken<LineReports>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageLonLatUriLineReportsAsync(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<LineReports> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatUriLineReportsValidateBeforeCall(lat, lon, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LineReports>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageLonLatUriLineReportsAsyncRaw(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<String > callback) throws ApiException {
    ...
    public class CoverageLonLatUriLineReportsRequestBuilder {
        ...
        public com.squareup.okhttp.Call get(final ApiCallback<LineReports > callback) throws ApiException {
            return currentApi.getCoverageLonLatUriLineReportsAsync(this.lat, this.lon, this.uri, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }

        public com.squareup.okhttp.Call rawGet(final ApiCallback<String > callback) throws ApiException {
            return currentApi.getCoverageLonLatUriLineReportsAsyncRaw(this.lat, this.lon, this.uri, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }
    }
    /**
    ...
    private com.squareup.okhttp.Call getCoverageRegionLineReportsValidateBeforeCall(String region, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionLineReportsCall(region, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    protected LineReports getCoverageRegionLineReports(String region, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        ApiResponse<LineReports> resp = getCoverageRegionLineReportsWithHttpInfo(region, depth, count, startPage, forbiddenUris, disableGeojson, since, until);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    private ApiResponse<LineReports> getCoverageRegionLineReportsWithHttpInfo(String region, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageRegionLineReportsValidateBeforeCall(region, depth, count, startPage, forbiddenUris, disableGeojson, since, until, null, null);
        Type localVarReturnType = new TypeToken<LineReports>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionLineReportsAsync(String region, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<LineReports> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionLineReportsValidateBeforeCall(region, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LineReports>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionLineReportsAsyncRaw(String region, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<String > callback) throws ApiException {
    ...
    public class CoverageRegionLineReportsRequestBuilder {
        ...
        public com.squareup.okhttp.Call get(final ApiCallback<LineReports > callback) throws ApiException {
            return currentApi.getCoverageRegionLineReportsAsync(this.region, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }

        public com.squareup.okhttp.Call rawGet(final ApiCallback<String > callback) throws ApiException {
            return currentApi.getCoverageRegionLineReportsAsyncRaw(this.region, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }
    }
    /**
    ...
    private com.squareup.okhttp.Call getCoverageRegionUriLineReportsValidateBeforeCall(String region, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionUriLineReportsCall(region, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    protected LineReports getCoverageRegionUriLineReports(String region, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        ApiResponse<LineReports> resp = getCoverageRegionUriLineReportsWithHttpInfo(region, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    private ApiResponse<LineReports> getCoverageRegionUriLineReportsWithHttpInfo(String region, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageRegionUriLineReportsValidateBeforeCall(region, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until, null, null);
        Type localVarReturnType = new TypeToken<LineReports>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionUriLineReportsAsync(String region, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<LineReports> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionUriLineReportsValidateBeforeCall(region, uri, depth, count, startPage, forbiddenUris, disableGeojson, since, until, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LineReports>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionUriLineReportsAsyncRaw(String region, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenUris, Boolean disableGeojson, DateTime since, DateTime until, final ApiCallback<String > callback) throws ApiException {
    ...
    public class CoverageRegionUriLineReportsRequestBuilder {
        ...
        public com.squareup.okhttp.Call get(final ApiCallback<LineReports > callback) throws ApiException {
            return currentApi.getCoverageRegionUriLineReportsAsync(this.region, this.uri, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }

        public com.squareup.okhttp.Call rawGet(final ApiCallback<String > callback) throws ApiException {
            return currentApi.getCoverageRegionUriLineReportsAsyncRaw(this.region, this.uri, this.depth, this.count, this.startPage, this.forbiddenUris, this.disableGeojson, this.since, this.until, callback);
        }
    }
}
