...
public class TrafficReportApi {
    ...
    private com.squareup.okhttp.Call getCoverageLonLatTrafficReportsValidateBeforeCall(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatTrafficReportsCall(lat, lon, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson, progressListener, progressRequestListener);
        return call;
     ...
     */
    protected TrafficReports getCoverageLonLatTrafficReports(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson) throws ApiException {
        ApiResponse<TrafficReports> resp = getCoverageLonLatTrafficReportsWithHttpInfo(lat, lon, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    private ApiResponse<TrafficReports> getCoverageLonLatTrafficReportsWithHttpInfo(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageLonLatTrafficReportsValidateBeforeCall(lat, lon, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson, null, null);
     ...
     */
    protected com.squareup.okhttp.Call getCoverageLonLatTrafficReportsAsync(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson, final ApiCallback<TrafficReports> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatTrafficReportsValidateBeforeCall(lat, lon, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TrafficReports>(){}.getType();
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageLonLatTrafficReportsAsyncRaw(BigDecimal lat, BigDecimal lon, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson, final ApiCallback<String > callback) throws ApiException {
    ...
    public class CoverageLonLatTrafficReportsRequestBuilder {
        ...
        public com.squareup.okhttp.Call get(final ApiCallback<TrafficReports > callback) throws ApiException {
            return currentApi.getCoverageLonLatTrafficReportsAsync(this.lat, this.lon, this.depth, this.count, this.startPage, this.forbiddenId, this.forbiddenUris, this.distance, this.disableGeojson, callback);
        }

        public com.squareup.okhttp.Call rawGet(final ApiCallback<String > callback) throws ApiException {
            return currentApi.getCoverageLonLatTrafficReportsAsyncRaw(this.lat, this.lon, this.depth, this.count, this.startPage, this.forbiddenId, this.forbiddenUris, this.distance, this.disableGeojson, callback);
        }
    }
    /**
    ...
    private com.squareup.okhttp.Call getCoverageLonLatUriTrafficReportsValidateBeforeCall(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatUriTrafficReportsCall(lat, lon, uri, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    protected TrafficReports getCoverageLonLatUriTrafficReports(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson) throws ApiException {
        ApiResponse<TrafficReports> resp = getCoverageLonLatUriTrafficReportsWithHttpInfo(lat, lon, uri, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    private ApiResponse<TrafficReports> getCoverageLonLatUriTrafficReportsWithHttpInfo(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageLonLatUriTrafficReportsValidateBeforeCall(lat, lon, uri, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson, null, null);
        Type localVarReturnType = new TypeToken<TrafficReports>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    protected com.squareup.okhttp.Call getCoverageLonLatUriTrafficReportsAsync(BigDecimal lat, BigDecimal lon, String uri, Integer depth, Integer count, Integer startPage, List<String> forbiddenId, List<String> forbiddenUris, Integer distance, Boolean disableGeojson, final ApiCallback<TrafficReports> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatUriTrafficReportsValidateBeforeCall(lat, lon, uri, depth, count, startPage, forbiddenId, forbiddenUris, distance, disableGeojson, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TrafficReports>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public class CoverageLonLatUriTrafficReportsRequestBuilder {
        ...
        public com.squareup.okhttp.Call get(final ApiCallback<TrafficReports > callback) throws ApiException {
            return currentApi.getCoverageLonLatUriTrafficReportsAsync(this.lat, this.lon, this.uri, this.depth, this.count, this.startPage, this.forbiddenId, this.forbiddenUris, this.distance, this.disableGeojson, callback);
        }

        public com.squareup.okhttp.Call rawGet(final ApiCallback<String > callback) throws ApiException {
            return currentApi.getCoverageLonLatUriTrafficReportsAsyncRaw(this.lat, this.lon, this.uri, this.depth, this.count, this.startPage, this.forbiddenId, this.forbiddenUris, this.distance, this.disableGeojson, callback);
        }
    }
    /**
