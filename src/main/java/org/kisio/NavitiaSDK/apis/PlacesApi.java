...
public class PlacesApi {
    ...
    private com.squareup.okhttp.Call getCoverageLonLatPlacesValidateBeforeCall(String basePath, String debugUrl, String q, BigDecimal lat, BigDecimal lon, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatPlacesCall(basePath, debugUrl, q, lat, lon, type, count, adminUri, depth, disableGeojson, from, shape, progressListener, progressRequestListener);
        return call;
    ...
    private ApiResponse<Places> getCoverageLonLatPlacesWithHttpInfo(String basePath, String debugUrl, String q, BigDecimal lat, BigDecimal lon, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageLonLatPlacesValidateBeforeCall(basePath, debugUrl, q, lat, lon, type, count, adminUri, depth, disableGeojson, from, shape, null, null);
     ...
     */
    protected com.squareup.okhttp.Call getCoverageLonLatPlacesAsync(String basePath, String debugUrl, String q, BigDecimal lat, BigDecimal lon, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ApiCallback<Places> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatPlacesValidateBeforeCall(basePath, debugUrl, q, lat, lon, type, count, adminUri, depth, disableGeojson, from, shape, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Places>(){}.getType();
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageLonLatPlacesAsyncRaw(String basePath, String debugUrl, String q, BigDecimal lat, BigDecimal lon, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ApiCallback<String > callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCoverageRegionPlacesValidateBeforeCall(String basePath, String debugUrl, String q, String region, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionPlacesCall(basePath, debugUrl, q, region, type, count, adminUri, depth, disableGeojson, from, shape, progressListener, progressRequestListener);
        return call;
    ...
    private ApiResponse<Places> getCoverageRegionPlacesWithHttpInfo(String basePath, String debugUrl, String q, String region, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageRegionPlacesValidateBeforeCall(basePath, debugUrl, q, region, type, count, adminUri, depth, disableGeojson, from, shape, null, null);
        Type localVarReturnType = new TypeToken<Places>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionPlacesAsync(String basePath, String debugUrl, String q, String region, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ApiCallback<Places> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionPlacesValidateBeforeCall(basePath, debugUrl, q, region, type, count, adminUri, depth, disableGeojson, from, shape, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Places>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionPlacesAsyncRaw(String basePath, String debugUrl, String q, String region, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ApiCallback<String > callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getPlacesValidateBeforeCall(String basePath, String debugUrl, String q, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPlacesCall(basePath, debugUrl, q, type, count, adminUri, depth, disableGeojson, from, shape, progressListener, progressRequestListener);
        return call;
    ...
    private ApiResponse<Places> getPlacesWithHttpInfo(String basePath, String debugUrl, String q, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape) throws ApiException {
        com.squareup.okhttp.Call call = getPlacesValidateBeforeCall(basePath, debugUrl, q, type, count, adminUri, depth, disableGeojson, from, shape, null, null);
        Type localVarReturnType = new TypeToken<Places>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getPlacesAsync(String basePath, String debugUrl, String q, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ApiCallback<Places> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPlacesValidateBeforeCall(basePath, debugUrl, q, type, count, adminUri, depth, disableGeojson, from, shape, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Places>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getPlacesAsyncRaw(String basePath, String debugUrl, String q, List<String> type, Integer count, List<String> adminUri, Integer depth, Boolean disableGeojson, String from, String shape, final ApiCallback<String > callback) throws ApiException {
