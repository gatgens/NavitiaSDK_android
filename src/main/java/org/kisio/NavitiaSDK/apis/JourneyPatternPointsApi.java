...
public class JourneyPatternPointsApi {
     ...
     */
    protected com.squareup.okhttp.Call getCoverageLonLatJourneyPatternPointsAsync(BigDecimal lat, BigDecimal lon, Integer startPage, Integer count, Integer depth, List<String> forbiddenId, List<String> forbiddenUris, String externalCode, String headsign, Boolean showCodes, String odtLevel, Integer distance, DateTime since, DateTime until, Boolean disableGeojson, String filter, final ApiCallback<JourneyPatternPoints> callback) throws ApiException {
