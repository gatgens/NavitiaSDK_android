...
public class GeoStatusApi {
     ...
     */
    private com.squareup.okhttp.Call getCoverageLonLatGeoStatusCall(String basePath, String debugUrl, BigDecimal lat, BigDecimal lon, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getCoverageLonLatGeoStatusValidateBeforeCall(String basePath, String debugUrl, BigDecimal lat, BigDecimal lon, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatGeoStatusCall(basePath, debugUrl, lat, lon, progressListener, progressRequestListener);
        return call;
    ...
    private ApiResponse<GeoStatus1> getCoverageLonLatGeoStatusWithHttpInfo(String basePath, String debugUrl, BigDecimal lat, BigDecimal lon) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageLonLatGeoStatusValidateBeforeCall(basePath, debugUrl, lat, lon, null, null);
     ...
     */
    protected com.squareup.okhttp.Call getCoverageLonLatGeoStatusAsync(String basePath, String debugUrl, BigDecimal lat, BigDecimal lon, final ApiCallback<GeoStatus1> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageLonLatGeoStatusValidateBeforeCall(basePath, debugUrl, lat, lon, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeoStatus1>(){}.getType();
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageLonLatGeoStatusAsyncRaw(String basePath, String debugUrl, BigDecimal lat, BigDecimal lon, final ApiCallback<String > callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    private com.squareup.okhttp.Call getCoverageRegionGeoStatusCall(String basePath, String debugUrl, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCoverageRegionGeoStatusValidateBeforeCall(String basePath, String debugUrl, String region, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionGeoStatusCall(basePath, debugUrl, region, progressListener, progressRequestListener);
        return call;
    ...
    private ApiResponse<GeoStatus1> getCoverageRegionGeoStatusWithHttpInfo(String basePath, String debugUrl, String region) throws ApiException {
        com.squareup.okhttp.Call call = getCoverageRegionGeoStatusValidateBeforeCall(basePath, debugUrl, region, null, null);
        Type localVarReturnType = new TypeToken<GeoStatus1>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionGeoStatusAsync(String basePath, String debugUrl, String region, final ApiCallback<GeoStatus1> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCoverageRegionGeoStatusValidateBeforeCall(basePath, debugUrl, region, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeoStatus1>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    protected com.squareup.okhttp.Call getCoverageRegionGeoStatusAsyncRaw(String basePath, String debugUrl, String region, final ApiCallback<String > callback) throws ApiException {
