...
import com.kisio.navitia.sdk.data.expert.invokers.auth.ApiKeyAuth;
import com.kisio.navitia.sdk.data.expert.invokers.auth.Authentication;
import com.kisio.navitia.sdk.data.expert.invokers.auth.HttpBasicAuth;
import com.kisio.navitia.sdk.data.expert.invokers.auth.OAuth;
...
public class ApiClient {
    ...
    public Date parseDatetime(String str) {
        ...
        if (lenientDatetimeFormat) {
            ...
            format = new SimpleDateFormat(LENIENT_DATETIME_FORMAT, Locale.ENGLISH);
        } else {
    ...
    private void initDatetimeFormat() {
        ...
        if (formatWithTimeZone != null) {
            this.datetimeFormat = new SimpleDateFormat(formatWithTimeZone, Locale.ENGLISH);
            // NOTE: Use the system's default time zone (mainly for datetime formatting).
        } else {
            // Use a common format that works across all systems.
            this.datetimeFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", Locale.ENGLISH);
