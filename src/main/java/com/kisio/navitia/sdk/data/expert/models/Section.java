...
public class Section implements Parcelable {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.links, section.links) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, departureDateTime, baseDepartureDateTime, duration, id, from, arrivalDateTime, additionalInformations, geojson, ridesharingInformations, to, baseArrivalDateTime, transferType, type, dataFreshness, co2Emission, path, cycleLaneLength, displayInformations, mode, ridesharingJourneys, stopDateTimes);
  }
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(cycleLaneLength);
  ...
  Section(Parcel in) {
    ...
    cycleLaneLength = (Integer)in.readValue(null);
