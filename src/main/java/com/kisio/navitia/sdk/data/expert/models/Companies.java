...
import com.kisio.navitia.sdk.data.expert.models.Companie;
...
public class Companies implements Parcelable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pagination, links, disruptions, notes, companies, feedPublishers, context, error);
  }
  ...
  Companies(Parcel in) {
    ...
    companies = (List<Companie>)in.readValue(Companie.class.getClassLoader());
  ...
  public static final Parcelable.Creator<Companies> CREATOR = new Parcelable.Creator<Companies>() {
