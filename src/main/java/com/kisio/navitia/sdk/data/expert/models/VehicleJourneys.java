...
import com.kisio.navitia.sdk.data.expert.models.VehicleJourney;
...
public class VehicleJourneys implements Parcelable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pagination, links, disruptions, notes, feedPublishers, context, error, vehicleJourneys);
  }
  ...
  public static final Parcelable.Creator<VehicleJourneys> CREATOR = new Parcelable.Creator<VehicleJourneys>() {
    public VehicleJourneys createFromParcel(Parcel in) {
      return new VehicleJourneys(in);
    }
    public VehicleJourneys[] newArray(int size) {
      return new VehicleJourneys[size];
    }
  };
}
