...
import com.kisio.navitia.sdk.data.expert.models.Code;
import com.kisio.navitia.sdk.data.expert.models.Comment;
import com.kisio.navitia.sdk.data.expert.models.JourneyPattern;
import com.kisio.navitia.sdk.data.expert.models.LinkSchema;
import com.kisio.navitia.sdk.data.expert.models.StopTime;
import com.kisio.navitia.sdk.data.expert.models.Trip;
import com.kisio.navitia.sdk.data.expert.models.ValidityPattern;
...
public class VehicleJourney implements Parcelable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, codes, name, journeyPattern, disruptions, startTime, headwaySecs, stopTimes, comments, validityPattern, endTime, id, trip, calendars);
  }
  ...
  VehicleJourney(Parcel in) {
    ...
    startTime = (String)in.readValue(null);
    headwaySecs = (Integer)in.readValue(null);
    ...
    endTime = (String)in.readValue(null);
