...
public class LinkSchema implements Parcelable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(category, commentType, title, internal, value, href, rel, templated, type, id);
  }
  ...
  LinkSchema(Parcel in) {
    ...
    commentType = (String)in.readValue(null);
