...
import com.kisio.navitia.sdk.data.expert.models.JourneyPatternPoint;
...
public class StopTime implements Parcelable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(stopPoint, utcArrivalTime, utcDepartureTime, headsign, arrivalTime, journeyPatternPoint, dropOffAllowed, pickupAllowed, departureTime);
  }
  ...
  public void writeToParcel(Parcel out, int flags) {
    ...
    out.writeValue(dropOffAllowed);

    out.writeValue(pickupAllowed);
  ...
  StopTime(Parcel in) {
    ...
    dropOffAllowed = (Boolean)in.readValue(null);
    pickupAllowed = (Boolean)in.readValue(null);
