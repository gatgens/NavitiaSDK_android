...
public class RouteSchedulesApi {
    ...
    protected RouteSchedules getCoverageLonLatUriRouteSchedules(String basePath, String debugUrl, BigDecimal lat, BigDecimal lon, String uri, String filter, DateTime fromDatetime, DateTime untilDatetime, Integer duration, Integer depth, Integer count, Integer startPage, Integer maxDateTimes, List<String> forbiddenId, List<String> forbiddenUris, String calendar, Integer distance, Boolean showCodes, String dataFreshness, Integer itemsPerSchedule, Boolean disableGeojson, String directionType) throws ApiException {
        ApiResponse<RouteSchedules> resp = getCoverageLonLatUriRouteSchedulesWithHttpInfo(basePath, debugUrl, lat, lon, uri, filter, fromDatetime, untilDatetime, duration, depth, count, startPage, maxDateTimes, forbiddenId, forbiddenUris, calendar, distance, showCodes, dataFreshness, itemsPerSchedule, disableGeojson, directionType);
        return resp.getData();
    }
     ...
     */
    protected okhttp3.Call getCoverageLonLatUriRouteSchedulesAsync(String basePath, String debugUrl, BigDecimal lat, BigDecimal lon, String uri, String filter, DateTime fromDatetime, DateTime untilDatetime, Integer duration, Integer depth, Integer count, Integer startPage, Integer maxDateTimes, List<String> forbiddenId, List<String> forbiddenUris, String calendar, Integer distance, Boolean showCodes, String dataFreshness, Integer itemsPerSchedule, Boolean disableGeojson, String directionType, final ApiCallback<RouteSchedules> callback) throws ApiException {
    ...
    public class CoverageLonLatUriRouteSchedulesRequestBuilder {
        ...
        public CoverageLonLatUriRouteSchedulesRequestBuilder withDirectionType(String directionType) {
    ...
    protected RouteSchedules getCoverageRegionUriRouteSchedules(String basePath, String debugUrl, String region, String uri, String filter, DateTime fromDatetime, DateTime untilDatetime, Integer duration, Integer depth, Integer count, Integer startPage, Integer maxDateTimes, List<String> forbiddenId, List<String> forbiddenUris, String calendar, Integer distance, Boolean showCodes, String dataFreshness, Integer itemsPerSchedule, Boolean disableGeojson, String directionType) throws ApiException {
        ApiResponse<RouteSchedules> resp = getCoverageRegionUriRouteSchedulesWithHttpInfo(basePath, debugUrl, region, uri, filter, fromDatetime, untilDatetime, duration, depth, count, startPage, maxDateTimes, forbiddenId, forbiddenUris, calendar, distance, showCodes, dataFreshness, itemsPerSchedule, disableGeojson, directionType);
        return resp.getData();
    }
    ...
    public class CoverageRegionUriRouteSchedulesRequestBuilder {
        ...
        public CoverageRegionUriRouteSchedulesRequestBuilder withDirectionType(String directionType) {
            this.directionType = directionType;
            return this;
        }
    ...
    private okhttp3.Call getRouteSchedulesValidateBeforeCall(String basePath, String debugUrl, String filter, DateTime fromDatetime, DateTime untilDatetime, Integer duration, Integer depth, Integer count, Integer startPage, Integer maxDateTimes, List<String> forbiddenId, List<String> forbiddenUris, String calendar, Integer distance, Boolean showCodes, String dataFreshness, Integer itemsPerSchedule, Boolean disableGeojson, String directionType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = getRouteSchedulesCall(basePath, debugUrl, filter, fromDatetime, untilDatetime, duration, depth, count, startPage, maxDateTimes, forbiddenId, forbiddenUris, calendar, distance, showCodes, dataFreshness, itemsPerSchedule, disableGeojson, directionType, progressListener, progressRequestListener);
        return call;
    ...
    protected RouteSchedules getRouteSchedules(String basePath, String debugUrl, String filter, DateTime fromDatetime, DateTime untilDatetime, Integer duration, Integer depth, Integer count, Integer startPage, Integer maxDateTimes, List<String> forbiddenId, List<String> forbiddenUris, String calendar, Integer distance, Boolean showCodes, String dataFreshness, Integer itemsPerSchedule, Boolean disableGeojson, String directionType) throws ApiException {
        ApiResponse<RouteSchedules> resp = getRouteSchedulesWithHttpInfo(basePath, debugUrl, filter, fromDatetime, untilDatetime, duration, depth, count, startPage, maxDateTimes, forbiddenId, forbiddenUris, calendar, distance, showCodes, dataFreshness, itemsPerSchedule, disableGeojson, directionType);
        return resp.getData();
    }
    ...
    private ApiResponse<RouteSchedules> getRouteSchedulesWithHttpInfo(String basePath, String debugUrl, String filter, DateTime fromDatetime, DateTime untilDatetime, Integer duration, Integer depth, Integer count, Integer startPage, Integer maxDateTimes, List<String> forbiddenId, List<String> forbiddenUris, String calendar, Integer distance, Boolean showCodes, String dataFreshness, Integer itemsPerSchedule, Boolean disableGeojson, String directionType) throws ApiException {
        okhttp3.Call call = getRouteSchedulesValidateBeforeCall(basePath, debugUrl, filter, fromDatetime, untilDatetime, duration, depth, count, startPage, maxDateTimes, forbiddenId, forbiddenUris, calendar, distance, showCodes, dataFreshness, itemsPerSchedule, disableGeojson, directionType, null, null);
        Type localVarReturnType = new TypeToken<RouteSchedules>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    protected okhttp3.Call getRouteSchedulesAsync(String basePath, String debugUrl, String filter, DateTime fromDatetime, DateTime untilDatetime, Integer duration, Integer depth, Integer count, Integer startPage, Integer maxDateTimes, List<String> forbiddenId, List<String> forbiddenUris, String calendar, Integer distance, Boolean showCodes, String dataFreshness, Integer itemsPerSchedule, Boolean disableGeojson, String directionType, final ApiCallback<RouteSchedules> callback) throws ApiException {
        ...
        okhttp3.Call call = getRouteSchedulesValidateBeforeCall(basePath, debugUrl, filter, fromDatetime, untilDatetime, duration, depth, count, startPage, maxDateTimes, forbiddenId, forbiddenUris, calendar, distance, showCodes, dataFreshness, itemsPerSchedule, disableGeojson, directionType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RouteSchedules>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public class RouteSchedulesRequestBuilder {
        ...
        public RouteSchedulesRequestBuilder withDirectionType(String directionType) {
            this.directionType = directionType;
            return this;
        }
