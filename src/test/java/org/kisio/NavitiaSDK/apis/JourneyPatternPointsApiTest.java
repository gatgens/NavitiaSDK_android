...
public void CoverageLonLatJourneyPatternPointsIdRequestBuilder_get_Test() throws Exception {
    ...
    requestBuilder.withLat(BigDecimal.valueOf(48.8459388));
    requestBuilder.withLon(BigDecimal.valueOf(2.3709227));
    requestBuilder.withId(String.valueOf("journey_pattern_point:476"));
...
public void CoverageLonLatUriJourneyPatternPointsRequestBuilder_get_Test() throws Exception {
    ...
    assertTrue(asyncResult[0].getJourneyPatternPoints().get(0) != null);
        ...
        @Test
public void CoverageLonLatUriJourneyPatternPointsIdRequestBuilder_get_Test() throws Exception {
    JourneyPatternPointsApi.CoverageLonLatUriJourneyPatternPointsIdRequestBuilder requestBuilder = new JourneyPatternPointsApi(testToken).newCoverageLonLatUriJourneyPatternPointsIdRequestBuilder();
...
public void CoverageRegionUriJourneyPatternPointsRequestBuilder_get_Test() throws Exception {
    ...
    assertTrue(asyncResult[0].getJourneyPatternPoints().get(0) != null);
        ...
        @Test
public void CoverageRegionUriJourneyPatternPointsIdRequestBuilder_get_Test() throws Exception {
    JourneyPatternPointsApi.CoverageRegionUriJourneyPatternPointsIdRequestBuilder requestBuilder = new JourneyPatternPointsApi(testToken).newCoverageRegionUriJourneyPatternPointsIdRequestBuilder();
