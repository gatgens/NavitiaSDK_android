...
public void CoverageLonLatJourneysRequestBuilder_get_Test() throws Exception {
    ...
    assertTrue(asyncResult[0].getJourneys().get(0) != null);
        ...
        @Test
@Ignore
public void CoverageLonLatUriJourneysRequestBuilder_get_Test() {}
...
public void CoverageRegionJourneysRequestBuilder_get_Test() throws Exception {
    ...
    assertTrue(asyncResult[0].getJourneys().get(0) != null);
        ...
        @Test
public void CoverageRegionUriJourneysRequestBuilder_get_Test() throws Exception {
    JourneysApi.CoverageRegionUriJourneysRequestBuilder requestBuilder = new JourneysApi(testToken).newCoverageRegionUriJourneysRequestBuilder();

    // Test case parameters
    requestBuilder.withRegion(String.valueOf("jdr"));
    requestBuilder.withUri(String.valueOf("stop_areas/stop_area:JDR:SA:GDLYO"));
    requestBuilder.withTo(String.valueOf("2.3665844;48.8465337"));
